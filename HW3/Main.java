package Exeptions.Homeworks.Homework_3;

import Exeptions.Homeworks.Homework_3.custom_exceptions.WrongLoginException;
import Exeptions.Homeworks.Homework_3.custom_exceptions.WrongPasswordException;
...
public class Main {
    ...
    private static void verify(String login, String password, String confirmPassword) throws WrongLoginException, WrongPasswordException {
